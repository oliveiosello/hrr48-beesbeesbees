...
// a job property that is set to find pollen x
...
// a canFly property that is set true x
// a treasureChest property that is set to an empty array [] x
// a forage method that allows the bee to add a treasure to the treasureChest x
